...
class Activated extends Action
{
    ...
    public function execute(): ResultInterface
    {
        ...
        try {
            ...
            $this->curl->addHeader('User-Agent', 'ETechFlow-FAQ/1.1');
        ...
        if ($block) {
            $block->setData('license_key', $licenseKey)
                  ...
                  ->setData('error', $error)
                  ->setData('settings_url', $this->getUrl('adminhtml/system_config/edit/section/etechflow_productwarning'))
                  ->setData('management_url', $this->getUrl('etechflow_warning/warning/index'));
        }
